...
export default function AdminHeader() {
  ...
  return (
    <header className="bg-white border-b border-slate-200 sticky top-0 z-1">
      <div className="flex items-center justify-end px-8 py-4">
        ...
        <div className="flex items-center gap-4 ml-6">
          ...
          {/* User Menu */}
          <button className="flex items-center gap-2 p-2 hover:bg-slate-50 rounded-lg transition-colors">
