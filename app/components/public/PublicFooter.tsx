    ...
    <footer className="bg-slate-900 text-slate-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <div>
                <h2 className="text-xl font-bold text-white">TailNews</h2>
              </div>
            </div>
            <p className="text-slate-400 mb-6 max-w-sm">
              Portal berita terpercaya yang menyajikan informasi terkini, akurat, dan berimbang dari berbagai sumber.
            </p>
        ...
        <div className="border-t border-slate-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-slate-400">
          <p>© {currentYear} TailNews. All rights reserved.</p>
